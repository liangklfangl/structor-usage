...
var ContextMenu = (function(_AbstractMenu) {
  ...
  function ContextMenu(props) {
    ...
    _this.handleMouseLeave = function(event) {
      ...
      (0, _helpers.callIfExists)(
        _this.props.onMouseLeave,
        event,
        (0, _objectAssign2.default)({}, _this.props.data, _helpers.store.data),
        _helpers.store.target
      );
  ...
  _createClass(ContextMenu, [
    ...
    },
    {
      ...
      value: function componentDidMount() {
        this.listenId = _globalEventListener2.default.register(
          this.handleShow,
          this.handleHide
        );
      }
        ...
        if (this.state.isVisible) {
          ...
          wrapper(function() {
            ...
            wrapper(function() {
              ...
              _this2.menu.style.top = 20 + "px";
              //   _this2.menu.style.left = left + "px";
              _this2.menu.style.left = 0 + "px";
    ...
    },
    {
      ...
      value: function render() {
        ...
        var inlineStyle = (0, _objectAssign2.default)({}, style, {
          position: "absolute",
          opacity: 0,
          pointerEvents: "none"
        });
        var menuClassnames = (0, _classnames2.default)(
          _helpers.cssClasses.menu,
          className,
          _defineProperty({}, _helpers.cssClasses.menuVisible, isVisible)
        );
